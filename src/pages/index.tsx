...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{` Mahi App`}</title>

        <meta
          name="description"
          content="Welcome to Mahi App - Your ultimate platform for dart programming and a treasure trove of English articles, designed to empower your learning journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1617040619263-41c5a9ca7521?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXJ0JTIwcHJvZ3JhbW1pbmd8ZW58MHx8fHwxNjk1MjkxNDI3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@roketpik?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Artur Shamsutdinov`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mahi App - Your ultimate platform for dart programming and a treasure trove of English articles, designed to empower your learning journey.`}
            </Text>
            <Box
